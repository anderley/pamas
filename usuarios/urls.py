...
urlpatterns = [
    ...
    path('alterar-senha/', views.CustomPasswordChangeView.as_view(), name='alterar_senha'),
    path('alterar-senha/feito/', views.CustomPasswordChangeDoneView.as_view(), name='senha_alterada'),
]
