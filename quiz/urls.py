...
urlpatterns = [
    ...
    path('formulario/cadastro/', views.CreateContatosView.as_view(), name='formulario_cadastro'), # noqa
    path('formulario/cadastro/<pk>/editar', views.ContatosUpdateView.as_view(), name='formulario_cadastro_editar'), # noqa
    path('formulario/<pk>/', views.show_form, name='formulario'),
    path('formulario2/<pk>/', views.FormularioFormView.as_view(), name='formulario2'), # noqa
